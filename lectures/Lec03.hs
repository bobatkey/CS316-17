...
{-    LECTURE 03 : DEFINING FUNCTIONS
   ...
   So far, we have looked at:
     ...
     - Data and Functions (Lecture 01); and
     - Some of the built-in Types of data (Lecture 02).
...
{- Sometimes, defining a function by patter matching is as simple as the
   'not2' function. Unfortunately, we also have to think a bit
